def justTrack():
    ...
    while (True):
        ...
        #   Type: 直线路点
        $ LINE: (7, "直线路点")
        movep(full_apply_touch_offset(
            [0.49343235928908513, -0.034010055610103646, 0.46814715553009045, -3.1393498921613574,
             3.2747143334013983E-6, -1.5707937412462627]), 1.2, 0.006, 0.001)
        # End: ELITECO Plugin Task Node
        # Begin: ELITECO Plugin Task Node
        #   Source: FullFunctionWelding, 1.3.0, ELITE ROBOTS
        #   Type: 直线路点_1
        $ LINE: (8, "直线路点_1")
        movep(full_apply_touch_offset(
            [0.4934321131006857, 0.0776781501655307, 0.46814651462718726, -3.1393488652548185, 1.643307675797863E-6,
             -1.5707982153518165]), 1.2, 0.006, 0.0)
        # End: ELITECO Plugin Task Node
        # Begin: ELITECO Plugin Task Node
        #   Source: FullFunctionWelding, 1.3.0, ELITE ROBOTS
        #   Type: MAG焊接开始 No.4
        ...
        $ LINE: (10, "直线路点_2")
        movep(full_apply_touch_offset(
            [0.38453316223443423, 0.07767716292490526, 0.46814569068226863, -3.139348962144205, -1.4514028083839158E-6,
             -1.5707958007623228]), 1.2, 0.006, 0.0)
        # End: ELITECO Plugin Task Node
        # Begin: ELITECO Plugin Task Node
        #   Source: FullFunctionWelding, 1.3.0, ELITE ROBOTS
        #   Type: 圆弧移动
        ...
        #   Type: 经过点
        $ LINE: (12, "经过点")
        movec(full_apply_touch_offset(
            [0.4991936784640643, 0.07767521465612638, 0.46814732390518593, -3.1393411895918963, -4.5268334246550145E-6,
             -1.570793086908474]), full_apply_touch_offset(
            [0.49919224820643354, -0.001796426312756797, 0.46814421999246814, -3.1393495132029683,
             -4.2176640709781915E-6, -1.5707986755361647]), 1.2, 0.006, 0.001, 1)
        # End: ELITECO Plugin Task Node
        # Begin: ELITECO Plugin Task Node
        #   Source: FullFunctionWelding, 1.3.0, ELITE ROBOTS
        #   Type: 结束点
