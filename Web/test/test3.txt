def dhgz():
    ...
    while (True):
        ...
        #   Type: 电弧跟踪开始 No.1
        $ LINE: (7, "电弧跟踪开始 No.1")
        if full_tracking_thread_id != 0:
            stop_thread(full_tracking_thread_id)
            path_offset_clear()
            full_tracking_thread_id = 0
        full_tracking_thread_id = start_thread(full_arc_tracking,
                                               (0.01, 3, 1, False, 0.0, 0.5, 0.5, 1, 1, 0.100, 0.100))
        # End: ELITECO Plugin Task Node
        # Begin: ELITECO Plugin Task Node
        #   Source: FullFunctionWelding, 1.3.0, ELITE ROBOTS
        #   Type: 摆动开始 No.2
